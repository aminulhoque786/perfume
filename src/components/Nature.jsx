          ...
          >
            ...
            <div className="absolute inset-0   flex flex-col items-center justify-center bg-black bg-opacity-50 text-white p-5">
              ...
              <div className="lg:pt-8">
                <button className="hover:text-white font-pops  duration-1000 ease-in-out font-semibold  px-4 py-2 bg-white hover:bg-slate-500 rounded text-black">
                  Explore
                </button>
              </div>
            </div>
          ...
          >
            ...
            <div className="absolute inset-0 font-pops  flex flex-col items-center justify-center bg-black bg-opacity-50 text-white p-4">
              ...
              <div className="lg:pt-6">
                <button className=" hover:text-white duration-1000 ease-in-out font-semibold  px-4 py-2 bg-white hover:bg-slate-500 rounded text-black">
                  Explore
                </button>
              </div>
            </div>
