...
import rose from "../assets/flower.webp";
import AOS from "aos";
import "aos/dist/aos.css";
import roses from "../assets/juio.jpg";
import care from "../assets/carrer.jpg";
import rosed from "../assets/liop.jpg";
const Company = () => {
  useEffect(() => {
    AOS.init({
    ...
    <>
      ...
      <div className="max-w-container mx-auto flex flex-col lg:flex-row items-center gap-10 pt-28">
        ...
        >
          ...
          <div className="pt-10 flex gap-4">
            <button className="font-gail duration-500 ease-in-out  px-4 py-2 hover:bg-slate-500 border border-black  hover:text-white text-black">
              Explore
            </button>
      ...
      <div className="max-w-container mx-auto flex flex-col md:flex-row items-center gap-10 pt-10 md:pt-28">
        ...
        >
          ...
          <div className="pt-10 flex gap-4">
            <button className="font-gail duration-500 ease-in-out font-semibold px-4 py-2 hover:bg-slate-500 border border-black rounded hover:text-white text-black">
              Discover More
            </button>
            <button className="font-gail duration-500 ease-in-out font-semibold px-4 py-2 hover:bg-slate-500 border border-black rounded hover:text-white text-black">
              Find Jobs
    ...
    <div className="w-full" data-aos="fade-up" data-aos-delay="500">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-transparent">
        ...
        <div className="pt-3 lg:pt-10 flex flex-col sm:flex-row gap-4">
          <button className="font-gail duration-500 ease-in-out font-semibold px-3 py-1 text-sm md:px-4 md:py-2 md:text-base hover:bg-slate-600 hover:text-white bg-white text-black">
            Discover More
          </button>
        </div>
      </div>
